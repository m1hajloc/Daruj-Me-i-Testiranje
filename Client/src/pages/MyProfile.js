...
function MyProfile() {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                ...
                const response = await axios.get(`https://localhost:7294/api/User/GetUserById?id=${userId}`, config); // Adjust the URL according to your backend route
    ...
    useEffect(() => {
        const fetchProducts = async () => {
          try {
            const response = await axios.get(`https://localhost:7294/api/Product/GetProductsByOwnerId?id=${userId}`); // Adjust the URL according to your backend route
...
useEffect(() => {
    const fetchUser = async () => {
        const response = await fetch(`https://localhost:7294/api/User/GetUser`, {
...
const handleReportUser = async () => {
    ...
    const response = await fetch(`https://localhost:7294/api/UserReport/CreateUserReport`, {
        method: 'POST',
        headers: {
