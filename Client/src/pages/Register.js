...
const clearProfilePicture = () => {
  ...
  const url = 'https://localhost:7294/api/User/Register';
                ...
                <MDBCard style={{ backgroundColor: 'grey', border: '2px solid rgba(255,255,255,0.3)' }} className="my-5 bg-glass">
                  <MDBCardBody className="p-5">
                    ...
                    <div className="kont">
                      ...
                      <button id="signin2" submit="true" style={{ border: 'none', backgroundColor: '#3d3d3d', color: 'white', width: '100%' }} type="submit" className="signInButton" >
                        Sign up
                      </button>
