...
function Edit({userId}) {
  ...
  const url='https://localhost:7294/api/User/EditUser';
              ...
              <MDBCardBody className="text-black p-4">
                <div className="mb-5 form-container">
                  ...
                  <div className="register-image-div">
                    ...
                    <MDBBtn id = "editbtn1" style={{backgroundColor:'#3a3a3a', width:'100%', border:'none'}} type="submit" submit='true' >Update Profile</MDBBtn>
                  </form>
                </div>
              </MDBCardBody>
            </MDBCard>
