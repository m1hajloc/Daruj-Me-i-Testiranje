...
function CustomNavbar({ userId, setUserId }) {
  ...
  const logout = () => {
    fetch('https://localhost:7294/api/User/Logout', {
      method: 'POST',
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <NavDropdown title="Admin" id="collapsible-nav-dropdown">
                                <NavDropdown.Item id = "prType" href="/ProductType">Product type</NavDropdown.Item>
                                <NavDropdown.Divider />
                                <NavDropdown.Item id ="repprod" href="/pages/reports">Reported products</NavDropdown.Item>
            ...
            <Nav>
              {userId === -1 ? (
                ...
                <NavDropdown style={{ display: 'flex', alignItems: 'center' }} title={
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item id = "logout1" onClick={logout}>Log out</NavDropdown.Item>
                </NavDropdown>)}
            </Nav>
          </Navbar.Collapse>
        </Container>
