...
namespace Controllers
{
   ...
   /*     [HttpPost]
        ...
        public async Task<IActionResult> GetAllUsers()
        {
         ...
         [Route("Register")]
        [HttpPost]
        public async Task<IActionResult> Register( UserRegisterDTO user,  IFormFile profilePicture)
        {
            try
            {
        ...
        [Route("EditUser")]
        [HttpPut]
        public async Task<IActionResult> EditUser( UserUpdateDTO us,  IFormFile profilePicture)
        {
            try
            {
